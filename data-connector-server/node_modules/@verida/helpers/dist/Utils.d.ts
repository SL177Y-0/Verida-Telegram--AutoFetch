import { FetchUriParams, IClient, Network } from '@verida/types';
/**
 ...
 * @returns
 */
export declare function buildVeridaUri(network: Network, did: string, contextName: string, databaseName: string, itemId?: string, deepAttributes?: string[], params?: {
    key?: string;
}): string;
/**
