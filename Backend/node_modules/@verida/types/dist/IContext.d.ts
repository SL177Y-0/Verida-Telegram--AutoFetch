...
export interface IContext {
    ...
    openProfile(profileName?: string, did?: string): Promise<IProfile | undefined>;
    ...
    openDatastore(schemaUri: string, config?: DatastoreOpenConfig): Promise<IDatastore>;
    openExternalDatastore(schemaUri: string, did: string, options?: DatastoreOpenConfig): Promise<IDatastore>;
